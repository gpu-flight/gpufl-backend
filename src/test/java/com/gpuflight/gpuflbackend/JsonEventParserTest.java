...
class JsonEventParserTest {
    ...
    void testParseInitEvent() throws Exception {
        ...
        InitEvent initEvent = parser.getObjectMapper().readValue(json, InitEvent.class);
        assertEquals(43700, initEvent.pid());
        assertEquals("block_style_demo", initEvent.app());
        assertEquals(1766907920508090978L, initEvent.tsNs());
    ...
    void testParseSystemSampleEvent() throws Exception {
        ...
        SystemSampleEvent systemSampleEvent = parser.getObjectMapper().readValue(json, SystemSampleEvent.class);
    ...
    void testParseShutdownEvent() throws Exception {
        ...
        ShutdownEvent shutdownEvent = parser.getObjectMapper().readValue(json, ShutdownEvent.class);
