...
class JsonEventParserTest {
    ...
    void testParseSystemStartEvent() throws Exception {
        String json = "{\"type\":\"system_start\",\"pid\":43700,\"app\":\"block_style_demo\",\"name\":\"system\",\"ts_ns\":381092980481600,\"host\":{\"cpu_pct\":2.1,\"ram_used_mib\":25500,\"ram_total_mib\":32189},\"devices\":[{\"id\":0,\"name\":\"NVIDIA GeForce RTX 5060 Laptop GPU\",\"uuid\":\"GPU-fc2e721b-a3b1-dc5b-63f0-76b7e624f037\",\"pci_bus\":2,\"used_mib\":252,\"free_mib\":7899,\"total_mib\":8151,\"util_gpu\":0,\"util_mem\":0,\"temp_c\":37,\"power_mw\":10735,\"clk_gfx\":562,\"clk_sm\":562,\"clk_mem\":12001,\"throttle_pwr\":1,\"throttle_therm\":0,\"pcie_rx_bw\":892928,\"pcie_tx_bw\":1024}]}";
        MetricEvent event = parser.parseEvent(json);
        assertTrue(event instanceof SystemStartEvent);
    ...
    void testParseKernelStartEvent() throws Exception {
        String json = "{\"type\":\"kernel_start\",\"pid\":43700,\"app\":\"block_style_demo\",\"name\":\"_Z9vectorAddPiS_S_i\",\"uuid\":\"\",\"ts_ns\":381093155152330,\"duration_ns\":0,\"grid\":\"(4,1,1)\",\"block\":\"(256,1,1)\",\"dyn_shared_bytes\":0,\"num_regs\":16,\"static_shared_bytes\":0,\"local_bytes\":0,\"const_bytes\":0,\"occupancy\":0,\"max_active_blocks\":0,\"corr_id\":132,\"cuda_error\":\"\"}";
        MetricEvent event = parser.parseEvent(json);
        assertTrue(event instanceof KernelBeginEvent);
    ...
    void testParseShutdownEvent() throws Exception {
        String json = "{\"type\":\"shutdown\",\"pid\":43700,\"app\":\"block_style_demo\",\"ts_ns\":381093852979000}";
        MetricEvent event = parser.parseEvent(json);
        assertTrue(event instanceof ShutdownEvent);
    ...
    void testParseEventWithType() throws Exception {
        String json = "{\"type\":\"shutdown\",\"pid\":43700,\"app\":\"block_style_demo\",\"ts_ns\":381093852979000}";
        MetricEvent event = parser.parseEvent(json, MetricType.shutdown);
        assertTrue(event instanceof ShutdownEvent);
        ShutdownEvent shutdownEvent = (ShutdownEvent) event;
        assertEquals(43700, shutdownEvent.pid());
    }
